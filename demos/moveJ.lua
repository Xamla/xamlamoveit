...
tic("startExperiment")
for i = 1,10 do
    ros.INFO("start moveJ")
    xamla_mg:moveJ(MoveJTest01, velocity_scaling, check_for_collisions)
    ros.INFO("finished moveJ")
    ros.INFO("start moveJ")
    xamla_mg:moveJ(MoveJTest02, velocity_scaling, check_for_collisions)
    ros.INFO("finished moveJ")
end
toc("startExperiment")
-- shutdown ROS
